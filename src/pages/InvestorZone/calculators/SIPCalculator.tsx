      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            ...
            />
            <h2 className="text-lg font-bold text-gray-800">SIP Calculator</h2>
          </div>

          <div className="relative w-full rounded-2xl overflow-hidden bg-white">
            <iframe
              src="https://www.investwell.in/updation/parameter/Calculator/par_sip_calculatorN.jsp?share=N"
              width="100%"
              height="800"
              frameBorder="0"
              scrolling="no"
